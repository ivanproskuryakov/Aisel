...
class LoadCategoryData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $rootCategory->setTitle('Product Root One');
        ...
        $rootCategory->setMetaUrl('product-product-root-category-one');
        ...
        $rootCategory = new Category();
        $rootCategory->setTitle('Product Root Two');
        ...
        $rootCategory->setStatus(true);
        $rootCategory->setMetaUrl('product-root-category-two');
        $rootCategory->setCreatedAt(new \DateTime(date('Y-m-d H:i:s')));
        $rootCategory->setUpdatedAt(new \DateTime(date('Y-m-d H:i:s')));
        $manager->persist($rootCategory);
        $manager->flush();
        ...
        $rootCategory = new Category();
        $rootCategory->setTitle('Product Root Three');
        ...
        $rootCategory->setStatus(true);
        $rootCategory->setMetaUrl('product-root-category-three');
        $rootCategory->setCreatedAt(new \DateTime(date('Y-m-d H:i:s')));
        $rootCategory->setUpdatedAt(new \DateTime(date('Y-m-d H:i:s')));
        $manager->persist($rootCategory);
        $manager->flush();
        ...
        $childCategory->setTitle('Product First 1');
        ...
        $childCategory->setMetaUrl('product-category-first-level-1');
        ...
        $childCategory = new Category();
        $childCategory->setTitle('Product First 2');
        ...
        $childCategory->setParent($rootCategory);
        $childCategory->setStatus(true);
        $childCategory->setMetaUrl('product-category-first-level-2');
        $childCategory->setCreatedAt(new \DateTime(date('Y-m-d H:i:s')));
        $childCategory->setUpdatedAt(new \DateTime(date('Y-m-d H:i:s')));
        $manager->persist($childCategory);
        $manager->flush();
        ...
        $childCategory = new Category();
        $childCategory->setTitle('Product First 3');
        ...
        $childCategory->setParent($rootCategory);
        $childCategory->setStatus(true);
        $childCategory->setMetaUrl('product-category-first-level-3');
        $childCategory->setCreatedAt(new \DateTime(date('Y-m-d H:i:s')));
        $childCategory->setUpdatedAt(new \DateTime(date('Y-m-d H:i:s')));
        $manager->persist($childCategory);
        $manager->flush();
        ...
        $nestedCategory->setTitle('Product Nested 1');
        ...
        $nestedCategory->setMetaUrl('product-category-nested-level-1');
        ...
        $nestedCategory = new Category();
        $nestedCategory->setTitle('Product Nested 2');
        ...
        $nestedCategory->setParent($childCategory);
        $nestedCategory->setStatus(true);
        $nestedCategory->setMetaUrl('product-category-nested-level-2');
        $nestedCategory->setCreatedAt(new \DateTime(date('Y-m-d H:i:s')));
        $nestedCategory->setUpdatedAt(new \DateTime(date('Y-m-d H:i:s')));
        $manager->persist($nestedCategory);
        $manager->flush();
        ...
        $nestedCategory = new Category();
        $nestedCategory->setTitle('Product Nested 3');
        ...
        $nestedCategory->setParent($childCategory);
        $nestedCategory->setStatus(true);
        $nestedCategory->setMetaUrl('product-category-nested-level-3');
        $nestedCategory->setCreatedAt(new \DateTime(date('Y-m-d H:i:s')));
        $nestedCategory->setUpdatedAt(new \DateTime(date('Y-m-d H:i:s')));
        $manager->persist($nestedCategory);
        $manager->flush();

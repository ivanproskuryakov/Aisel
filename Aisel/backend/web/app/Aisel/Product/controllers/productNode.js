...
define(['app'], function(app) {
    app.controller('ProductNodeCtrl', function($scope, $stateParams, $state, Environment) {
        ...
        $scope.nodeJson = Environment.settings.apiBackend + '/product/node/?locale=' + $stateParams.lang;
        $scope.nodeUpdate = Environment.settings.apiBackend + '/product/node/node/?locale=' + $stateParams.lang;
